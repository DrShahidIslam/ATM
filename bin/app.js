...
let shahid = { customerName: "shahid", password: 1234, bankBalance: Math.round(Math.random() * 100000) };
let zohaib = { customerName: "zohaib", password: 1234, bankBalance: Math.round(Math.random() * 100000) };
let shoaib = { customerName: "shoaib", password: 1234, bankBalance: Math.round(Math.random() * 100000) };
let rayyan = { customerName: "rayyan", password: 1234, bankBalance: Math.round(Math.random() * 100000) };
let customerDetails = [];
